...
if viz_mode == "País único":
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            dragmode='zoom',
            hoverlabel=dict(bgcolor="#232946", font_size=13, font_family="sans-serif"),
            xaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikecolor='#cccccc', spikethickness=0.35, spikedash='solid'),
            yaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikecolor='#cccccc', spikethickness=0.35, spikedash='solid'),
            modebar=dict(orientation='v')
        )
    ...
    with compare_tabs[1]:
        ...
        fig_rank.update_layout(
            ...
            hoverlabel=dict(bgcolor="#232946", font_size=13, font_family="sans-serif"),
            xaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikecolor='#cccccc', spikethickness=0.35, spikedash='solid'),
            yaxis=dict(categoryorder='total ascending', showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikecolor='#cccccc', spikethickness=0.35, spikedash='solid'),
            modebar=dict(orientation='v')
        )
