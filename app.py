...
if viz_mode == "País único":
    ...
    with col1:
        ...
        fig.update_layout(
            ...
            dragmode='zoom',
            hoverlabel=dict(bgcolor="#232946", font_size=13, font_family="sans-serif"),
            xaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikedash='dot', spikecolor='#b0b0b0', spikethickness=1.2),
            yaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikedash='dot', spikecolor='#b0b0b0', spikethickness=1.2),
            modebar=dict(orientation='v')
        )
    ...
    with compare_tabs[1]:
        ...
        fig_rank.update_layout(
            ...
            hoverlabel=dict(bgcolor="#232946", font_size=13, font_family="sans-serif"),
            xaxis=dict(showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikedash='dot', spikecolor='#b0b0b0', spikethickness=1.2),
            yaxis=dict(categoryorder='total ascending', showspikes=True, spikemode='across', spikesnap='cursor', showline=True, showgrid=True, zeroline=False, showticklabels=True, spikedash='dot', spikecolor='#b0b0b0', spikethickness=1.2),
            modebar=dict(orientation='v')
        )
